...
- [DECISION] The package name is `godpowers`, and the current repository version is `3.10.0`.
...
- [HYPOTHESIS] Documentation drift risk is high because the public surface includes 120 slash commands, 40 specialist agents, 13 workflows, and 43 intent recipes.
