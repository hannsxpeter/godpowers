...
const SAFE_TEMPLATES = [
  ...
  {
    id: 'permission-reaudit',
    title: 'Permission re-audit (loop hardening)',
    cadence: 'Monthly, every 30 days',
    risk: 'read-only',
    prompt: 'Run a read-only permission and attack-surface re-audit. Review external connector write scope in .godpowers/connectors.json, automation reach in .godpowers/automations.json, credential handling, and host sandbox scope. Report drift and whether /god-harden should run, then record completion via lib/reaudit.js. Do not widen scopes, change permissions, or clear findings.'
  },
  {
