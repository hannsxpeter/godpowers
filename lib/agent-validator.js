...
/**
 * Walk specialists/ and audit all shipped specialist agent source contracts.
 * Installed host copies still live under each host's agents/ directory.
 */
function auditAll(projectRoot, opts = {}) {
  const agentsDir = path.join(projectRoot, 'specialists');
