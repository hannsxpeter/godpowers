...
const SYSTEM_TARGETS = {
  ...
  // .mdx (unlike the legacy .md companions in foreign dirs). PLAN.mdx and
  // AUDIT.json and its generated AUDIT.mdx view are owned by godaudits and
  // never receive fences, so pointerCandidates stays empty for both.
  godplans: {
