...
- [HYPOTHESIS] godaudits audit found: [.godaudits/AUDIT.mdx or "none detected"].
...
- [DECISION] Sibling `.godplans/PLAN.mdx` and `.godaudits/AUDIT.mdx` artifacts stay owned by their products: import seeds from them, keep the originals read-only, and write back only through `.godplans/GODPOWERS-SYNC.mdx` or `.godaudits/GODPOWERS-SYNC.mdx`.
