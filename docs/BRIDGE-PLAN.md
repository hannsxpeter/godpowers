...
- [DECISION] Remaining Phase 4 work: add generated checksummed per-tier state views, add remaining per-tier static decision-read checks, update dogfood fixtures, and run the final 2.7.0 release path.
