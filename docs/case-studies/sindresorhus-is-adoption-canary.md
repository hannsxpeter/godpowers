...
- [DECISION] Repository: https://github.com/sindresorhus/is.git
- [DECISION] External HEAD at capture time: `7821031c66cdeb7256a0feb2d506535f9e84fcaf`.
- [DECISION] Clone path: /var/folders/7s/sfyh12m94v13w49y9fnyywyc0000gn/T/godpowers-canary-l0811s/github-com-sindresorhus-is
- [DECISION] Clone retention: removed by the canary harness after the report was written.
- [DECISION] Observed command elapsed time: 3.117 seconds from local terminal output.
