...
- [DECISION] Repository: https://github.com/expressjs/cors.git
- [DECISION] External HEAD at capture time: `5317ebe670db2aaebc1d496eb5d33493deefb3ed`.
- [DECISION] Clone path: /var/folders/7s/sfyh12m94v13w49y9fnyywyc0000gn/T/godpowers-canary-eQmqw5/github-com-expressjs-cors
- [DECISION] Clone retention: removed by the canary harness after the report was written.
- [DECISION] Observed command elapsed time: 2.828 seconds from local terminal output.
