...
const commands = [
  ...
  // Tier 2
  {
    ...
    writes: ['.godpowers/repo/AUDIT.mdx', 'repo source files'],
  ...
  },
  {
    ...
    writes: ['.godpowers/build/PLAN.mdx', '.godpowers/state.json', 'source code'],
  ...
  // Tier 3
  {
    ...
    writes: ['.godpowers/state.json', 'deploy config', '.godpowers/deploy/WAITING-FOR-EXTERNAL-ACCESS.mdx when needed'],
  ...
  // Beyond greenfield
  {
    ...
    writes: ['.godpowers/features/<slug>/PRD.mdx', 'feature code'],
    next: '/god-status',
  },
  {
  ...
  },
  {
    ...
    writes: ['.godpowers/migrations/<slug>/MIGRATION.mdx'],
  ...
  },
  {
    ...
    prereq: [],
    writes: ['.godpowers/docs/UPDATE-LOG.mdx', 'README and docs'],
  ...
  },
  {
    ...
    writes: ['.godpowers/deps/AUDIT.mdx'],
  ...
  { cmd: '/god-explore', tier: 0, agent: 'god-explorer', desc: 'Pre-init Socratic ideation', prereq: [], writes: ['.godpowers/explore/<slug>.mdx'], next: '/god-init' },
  { cmd: '/god-discuss', tier: 0, agent: 'god-explorer', desc: 'Pre-planning discussion', prereq: [], writes: ['.godpowers/discussions/<topic>.mdx'], next: 'varies' },
  ...
  { cmd: '/god-pause-work', tier: 0, agent: 'built-in', desc: 'Save context handoff', prereq: [], writes: ['.godpowers/HANDOFF.mdx'], next: 'session-end' },
  { cmd: '/god-resume-work', tier: 0, agent: 'built-in', desc: 'Restore from handoff', prereq: ['file:.godpowers/HANDOFF.mdx'], writes: [], next: 'varies' },
